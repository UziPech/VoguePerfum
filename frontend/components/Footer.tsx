            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="text-center space-y-4">
                    ...
                    <h3 className="text-lg md:text-xl font-bold tracking-widest uppercase font-playfair italic">
                        Vogue Perfum<sup className="text-[10px]">®</sup>
                    </h3>
                    ...
                    <p className="text-xs text-gray-500 uppercase tracking-wider">
                        © {currentYear} Vogue Perfum<sup className="text-[8px]">®</sup>. Todos los derechos reservados.
                    </p>

                    {/* Legal Disclaimer */}
                    <p className="text-xs text-gray-400 max-w-2xl mx-auto leading-relaxed">
                        Vogue Perfum<sup className="text-[8px]">®</sup> es una marca registrada.
